...
export default function MostPublishedPersonMonth({
  mostActiveAuthors,
  authors,
}) {
  const displayData = mostActiveAuthors.month || {}; // Use the first entry or an empty object
...
"
      ...
      <div>
        ...
        <h2 className="text-lg  text-white font-black">
          פרסם הכי הרבה
          <span className="text-[#FBBF00] pr-1">החודש</span>
        </h2>
      </div>
    </div>
  );
